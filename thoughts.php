...
<html lang="en">
    ...
    <body>
        ...
        <!-- Twitter -->
        <script src="https://d1gwmq5m0jn0pk.cloudfront.net/js/twitterFetcher.min.js"></script>
        <script src="https://d1gwmq5m0jn0pk.cloudfront.net/js/todds_tweets.js"></script>
